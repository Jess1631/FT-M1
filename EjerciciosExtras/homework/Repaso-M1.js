...
var countProps = function(obj) {
    ...
    for(let prop in obj){
        ...
        if(typeof obj[prop] === 'object'){
            ...
            if(!Array.isArray(obj[prop])){  // q no sea un arreglo
...
var mergeQueues = function(queueOne, queueTwo) {
    ...
    // queue no tiene .length ! -> tiene una propiedad array a la se le puede aplicar el .length
    while(queueOne.size() || queueTwo.size()){
        let firstElement = queueOne.dequeue(); // me devuelve el primer elemneto del array 1
        let secondElement = queueTwo.dequeue(); // me devuelve el primer elemneto del array 2
